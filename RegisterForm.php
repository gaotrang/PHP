    ...
    <?php
        ...
        if(isset($_POST['register'])){
            ...
            if($_FILES['avatar_url']){
                $target_dir = "uploads/";
                $target_file = $target_dir . uniqid(true).'_'. basename($_FILES["avatar_url"]["name"]);
